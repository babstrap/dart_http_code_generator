...
(function() {
  var DartNetHTTPCodeGenerator, addslashes;
  ...
  DartNetHTTPCodeGenerator = function() {
  ...
  DartNetHTTPCodeGenerator.identifier = "com.babstrap.DartNetHTTPCodeGenerator";
  DartNetHTTPCodeGenerator.title = "Dart (HTTP)";
  DartNetHTTPCodeGenerator.fileExtension = "dart";
  DartNetHTTPCodeGenerator.languageHighlighter = "java";

  registerCodeGenerator(DartNetHTTPCodeGenerator);
